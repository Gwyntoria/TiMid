...
def drop_coin():
    try:
        ...
        loge("drop_coin - Exception: " + str(e))
    except OSError as e:
        logger.error("drop_coin OSError: " + str(e))
    except:
        loge("drop_coin - Error")
...
def handle_jp_detect():
    ...
    if user_in_room is True:
        ...
        if r_json != 0 and web_socket_thread is not None:
            json_info = r_json
...
def move_brush():
    ...
    try:
        ...
        loge("move_brush - Exception: " + str(e))
    except OSError as e:
        logger.error("move_brush OSError: " + str(e))
    except:
        loge("move_brush - Error")
        ...
        while True:
            try:
                ...
                if result == 0:
                    ...
                    # logd("GPIO.LOW time: " + str(int(time.time() * 1000)))
                    if playing is True:
                        coins_count += 1
